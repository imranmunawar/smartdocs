...
from smartdocs_app.views.utils import validate_vimeo_link
# from ..s3.client import S3_Client
from ..gcs.client import GCS_Client
from smartdocs_app.views.utils import placeholder_validation, template_modified
...
def view_template_sections(request, template_id:int):
    ...
    if request.user.is_staff:
        ...
        return render(request, 'smartdocs_app/admin_template.html', context=context)
...
def view_section_subsections(request, template_id:int, section_id:int):
    ...
    if request.user.is_staff:
        ...
        if not template.is_active:
            messages.error(request, 'This template is inactive', extra_tags=messageEnum.DANGER.value)
        return render(request, 'smartdocs_app/admin_subsections.html', context=context)
...
def get_root_questions(request, template_id:int, section_id:int):
    ...
    if request.user.is_staff:
        ...
        try:
            ...
            if not template.is_active:
                messages.error(request, 'This template is inactive', extra_tags=messageEnum.DANGER.value)
            return render(request, 'smartdocs_app/admin_questions.html', context=context)
...
def get_questins_and_placeholders(request, template_id:int):
    ...
    if request.user.is_staff:
        ...
        if not template.is_active:
            messages.error(request, 'This template is inactive', extra_tags=messageEnum.DANGER.value)
        return render(request, 'smartdocs_app/admin_questions_placeholders.html', context=context)
...
def get_child_questions(request, template_id:int, section_id:int, question_id:int):
    ...
    if request.user.is_staff:
        ...
        if not template.is_active:
            messages.error(request, 'This template is inactive', extra_tags=messageEnum.DANGER.value)
        return render(request, 'smartdocs_app/admin_subquestions.html', context=context)
